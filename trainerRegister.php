...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "test")) {
  ...
  $insertSQL = sprintf("INSERT INTO trainer (`Trainer ID`, `First Name`, `Last Name`, AvgPrice, City, `State`, Zip, Username, Password, Email, `Phone Number`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       'NULL',
			...
			else
{
	...
	<ul class="menu" style="text-align:right"> 
			...
			<li><a href = trainerRegister.php style="color: red">Trainer</a></li>
			<li><a href = gymRegister.php style="color: black">Gym<a></li>
		</ul>
	<blockquote><font color="#9999FF" size="7" face="CENTURY GOTHIC">Register new trainer here:</font><br>
	</blockquote>
	...
	<form action="<?php echo $loginFormAction; ?>" name="test" method="POST" >
      ...
      <p>
        <label>&nbsp &nbsp &nbsp &nbsp Avg Hourly Rate:</label>
        <input name="Rate" type="text" id="Rate" placeholder="Rate in Dollars" title="email">
<br>
        <br>
      ...
      <p><a href="trainerLogIn.php">Already registered? Sign in here</a></p>
      <p><br>
        </blockquote></div>
