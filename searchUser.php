			...
			else
{
		...
		<div class ="testing">
	<blockquote><font face="CENTURY GOTHIC" size="7" color="#9999FF">Search Users</font></blockquote></div><br><br><br>
		 
		 

		
						<img src="images/search1.jpg" width="500" height="400" name="slide" align = "left"><br><br><br><br><br><br>
						

			

			<!--<br><font face="LA BAMBA LET" size="7" color="#9999FF"><center>Let's find you a gym</center></font></br>-->
			<br><font face="TECHNIC" size="6" color="#3366FF" align="right"><center>To find the user that you are looking for <br>enter their user name</font></center>
			...
			<div class="quote">
			 <blockquote><form name="test" method="POST" > 
			 	<br>
			<label>&nbsp &nbsp &nbsp &nbsp Enter User name:</label> 
			<input type="text" name="name" placeholder="Username"><br>	<br>
			
				
		<br><input type="submit" name="submit" value="Find User"></button></blockquote></div><br><br>
...
{ 
	...
	if(!empty($_POST['name'])){
	$sql = "SELECT * FROM mydb.user WHERE `Username` LIKE '$_POST[name]'";
