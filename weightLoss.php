			...
			else
{
		...
		<ul class="chain" style="text-align:left"> 
			...
			<li><a href = "#" style="color: black">Weight Loss</a></li>
		</ul>

		<div class ="testing">
		<blockquote><font face="ARIAL BLACK" size="7" color="#9999FF">Forums</font></blockquote></div>
		 <div class ="C_Header" style="text-align:left">
    <h2><font face="ARIAL" size = "50px">Categories: Weight Loss</h2>	
	...
	$sql = "SELECT * FROM mydb.forumpost WHERE `Topic` = 'Weight Loss'";
