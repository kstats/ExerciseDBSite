  ...
  return $theValue;
	...
	while($row = mysql_fetch_array($retval, MYSQL_ASSOC))
	{
		echo'<div class="quote">
			...
			<input type="text" name="Rate" value='.$row['PriceRange'] .'><br><br>	
...
$dbhost = 'localhost';
 ...
 {
	 $test = "SELECT * FROM mydb.gym WHERE `Username` LIKE '$_SESSION[MM_Username]'";
	 mysql_select_db('GYM');
  ...
  $address =                    	GetSQLValueString(isset($_POST['Address']) ? $_POST['Address'] : null, "text");
   ...
   $state =                    	GetSQLValueString(isset($_POST['State']) ? $_POST['State'] : null, "text");
     $zip =                  	GetSQLValueString(isset($_POST['Zip']) ? $_POST['Zip'] : null, "text");
      $name=             GetSQLValueString(isset($_POST['Name']) ? $_POST['Name'] : null, "text");
$rate =                   GetSQLValueString(isset($_POST['Rate']) ? $_POST['Rate'] : null, "text");

 $order = "UPDATE mydb.gym SET email = $email, Password = $pass, `Address` = $address,
 City = $city,
 State = $state, `Zip Code` = $zip, `Name` = $name, `PriceRange` = $rate WHERE `username` LIKE '$_SESSION[MM_Username]'";
mysql_select_db('GYM');
