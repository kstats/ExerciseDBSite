...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "test")) {
  ...
  $insertSQL = sprintf("INSERT INTO `user` (ID, username, email, password, Gender, Address, City, `State`, `Zip Code`, Height, Weight, BMI, `First Name`, `Last Name`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['BMI'], "double"),
			...
			else
{
	...
	<ul class="menu" style="text-align:right"> 
			<li><a href = register.php style="color: red">User</a></li>
			<li><a href = trainerRegister.php style="color: black">Trainer</a></li>
			<li><a href = gymRegister.php style="color: black">Gym<a></li>
		</ul>
	<blockquote><font color="#9999FF" size="7" face="CENTURY GOTHIC">Register new user here:</font><br>
	</blockquote>
	...
	<form action="<?php echo $loginFormAction; ?>" name="test" method="POST" >
      <p>
        ...
        <input name="FirstName" type="text" id="FirstName" placeholder="First name" title="FirstName">
      <p>
        <label>&nbsp &nbsp &nbsp &nbsp Last Name:</label>
        <input name="LastName" type="text" id="LastName" placeholder="Last name" title="LastName">
      </p>
      <p>
      ...
      <input name="Height" type="text" id="Height" placeholder="Height in inches" title="height">
      <label><br>
        <br>
        &nbsp &nbsp &nbsp &nbsp Weight:</label>
        <input name="Weight" type="text" id="Weight" placeholder="Weight in pounds">
</p><p>
          <label>&nbsp &nbsp &nbsp &nbsp BMI:</label>
          <input name="BMI" type="text" id="BMI" placeholder="BMI">
          <br>
          <br>
...
<p>
    <input type="submit" name="submit" value="Submit">
      ...
      <p><a href="logIn.php">Already registered? Sign in here</a></p>
      <p><br>
        </blockquote></div>
