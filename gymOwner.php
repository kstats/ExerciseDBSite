			...
			else
{
		...
		<blockquote><font face="CENTURY GOTHIC" size="7" color="#9999FF">Add Gym Info</font></blockquote><br><br><br><br><br><br>
		
		 

		
						<img src="images/owner.jpg" width="500" height="400" name="slide" align = "right">
						

			

			<br><blockquote><font face="LA BAMBA LET" size="7" color="#9999FF"><center>Let's sign your gym up</center></font></blockquote></br>
			<br><blockquote><font face="TECHNIC" size="5" color="#3366FF" align="left"><center>Thank you for choosing A Better You<br> to advertise your gym! Please see the below sections to fill out</font></center></blockquote></br><br><br><br><br><br><br>
		


			<br><br><br><br><br><br>
			<h2><center>Please fill out all fields!</center></h2>

			<div class="quote">
			<blockquote><form name="test" method="" > 
			 	<br>
			<label>&nbsp &nbsp &nbsp &nbsp Address:</label>	
				<input type="text" name="name" placeholder="Enter Address"><br>
			 <form name="test" method="" > 
			 	<br>
			<label>&nbsp &nbsp &nbsp &nbsp City:</label>	
			<input type="text" name="name" placeholder="Enter City">
			<label>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  State: </label>	
			<select>
				...
				<input type="text" name="name" placeholder="Enter Zip code"> <br>
				<br>
				<form name="test" method="" > 
				<label>&nbsp &nbsp &nbsp &nbsp Email:</label>	
				<input type="text" name="name" placeholder="someemail@host.com"><br>
				<br>
				<form name="test" method="" > 
				<label>&nbsp &nbsp &nbsp &nbsp Phone Number:</label>	
				<input type="text" name="name" placeholder="Enter Phone number"><br>

			
				<br>
			<input type="submit" name="submit" value="Submit"></button><br><br><br><br><br><br></blockquote></div>
