			...
			else
{
		...
		<ul class="menu" style="text-align:left"> 
			<li><c href = "#" style="color: black">Categories</a></li>
		</ul>

		<div class ="testing">
		<blockquote><font face="ARIAL BLACK" size="7" color="#9999FF">Tips and Tricks</font></blockquote></div><br><br>
		 <div class ="C_Header" style="text-align:center">
		 <h2><font face="ARIAL" size = "50px">Categories</h2>	

		<table align="center" border="3" style="width:700px">
			<tr>
			  <td><a href = diet.php style="color:black"> Diet</a></td>
			</tr>
			<tr>
			  <td><a href = running.php style="color:black"> Running</a></td
			></tr>
			<tr>
			 <td><a href = weights.php style="color:black"> Weights</a></td
			></tr>
			<tr>
			  <td><a href = marathons.php style="color:black"> Marathons</a></td
			></tr>
			<tr>
			  <td><a href = weightLoss.php style="color:black">Weight Loss</a></td
			></tr>
			<tr>
			  <td><a href = other.php style="color:black"> Other</a></td
			></tr>
