			...
			else
{
		...
		<div class ="testing">
		<blockquote><font face="CENTURY GOTHIC" size="7" color="#9999FF">Search for Gym Clients</font></blockquote></div><br><br><br><br>
		 
		 

		
						<img src="images/search1.jpg" width="500" height="400" name="slide" align = "left">
						

			

			<!--<br><font face="LA BAMBA LET" size="7" color="#9999FF"><center>Let's find you a gym</center></font></br>-->
			<br><font face="TECHNIC" size="6" color="#3366FF" align="right"><center>To find the user that you are looking for <br>enter their user name, BMI or ZIP</font></center>
		...
		<br><input type="submit" name="submit" value="Find User"></button></blockquote></div><br><br><br><br>
...
{ 
	...
	$sql = "SELECT * FROM mydb.user WHERE `Username` LIKE '$_POST[username]'";
	...
	if(!empty($_POST['zip'])){
	$sql = "SELECT * FROM mydb.user WHERE `Zip Code` LIKE '$_POST[zip]'";
	mysql_select_db('USER');
	$retval = mysql_query( $sql, $conn );
	if(! $retval )
	{
