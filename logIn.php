			...
			else
{
	...
	<ul class="menu" style="text-align:right"> 
			<li><a href = logIn.php style="color: red">User</a></li>
			<li><a href = trainerLogIn.php style="color: black">Trainer</a></li>
			<li><a href = gymLogIn.php style="color: black">Gym<a></li>
	</ul>
	<div class ="testing">
	  <blockquote>
	    <p><font color="#9999FF" size="7" face="CENTURY GOTHIC">User Log in:</font><br>
        </p>
	    ...
	    <p><font color="#9999FF" size="7" face="CENTURY GOTHIC"><a href="register.php">New User? Register here</a></font><br>
	  <br>
    </blockquote>
	</div>
