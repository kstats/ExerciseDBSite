...
<ul class="menu" style="text-align:right"> 
			<li><a href = findGymClients.php style="color: black">Find Clients</a></li>
			<li><a href = gymAboutMe.php style="color: black">About Me<a></li>
			<li><a href = gymInfoSettings.php style="color: black">Settings</a></li>
		</ul>
		
		<blockquote><font face="CENTURY GOTHIC" size="7" color="#6699CC">Gym Profile</font></blockquote><br><br><br><br><br><br>
		...
		<img src="images/gymbuilding.jpg" width="500" height="400" name="slide" align = "left" hspace = "20px">
...
{ 
	...
	$sql = "SELECT * FROM mydb.gym WHERE `Username` LIKE '$_SESSION[MM_Username]'";
	mysql_select_db('GYM');
 ...
 ?>	
			...
			<!--<br><blockquote><font face="LA BAMBA LET" size="7" color="#9999FF"><center>Scroll down to view </center></font></blockquote></br>
			<br><blockquote><font face="TECHNIC" size="5" color="#3366FF" align="right">
			<center><label>Rating:</label><br>
			<label>Address:</label><br>
			<label>City:</label><label>&nbsp &nbsp State:</label><label>&nbsp &nbsp Zip Code:</label> 

			</font></center></blockquote></br><br><br><br><br><br><br>
