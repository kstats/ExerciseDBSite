			...
			else
{
	...
	<ul class="menu" style="text-align:right"> 
			...
			<li><a href = trainerLogIn.php style="color: black">Trainer</a></li>
			<li><a href = gymLogIn.php style="color: red">Gym<a></li>
	</ul>
	<div class ="testing">
	  <blockquote>
	    <p><font color="#9999FF" size="7" face="CENTURY GOTHIC">Gym Log in:</font><br>
        </p>
	    ...
	    <p><font color="#9999FF" size="7" face="CENTURY GOTHIC"><a href="gymRegister.php">New Gym? Register here</a></font><br>
	  <br>
    </blockquote>
	</div>
